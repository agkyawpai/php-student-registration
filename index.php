                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <?php
                            ...
                            $sql_query = "SELECT student_id FROM students ORDER BY student_id DESC LIMIT 1";
                            if ($result = $conn->query($sql_query)) {
                                $row = $result->fetch_assoc();
                                $stu_id = $row['student_id']+1;
                                echo "<input type='text' name='stu_id' id='id' class='form-control' value='$stu_id' readonly='true'>";
                            }
                            ?>
                    ...
                    <div class="form-group col-lg-6 mt-4">
                        <label for="fileselect">Upload Photo : </label>
